...
```javascript
{
    ...
    "dependencies": {
        ....
        "pip-services-changescopes-node": "^1.0.0",
        ...
    }
}
```
...
var plugin = require('pip-services-changescopes-node').ChangeScopesSenecaPlugin;
...
or by using [ChangeScopesSenecaClient](https://github.com/pip-services-infrastructure/pip-clients-changescopes-node/NodeClientApiV1.md/#client_seneca)